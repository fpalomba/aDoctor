...
import it.aDoctor.beans.InstanceVariableBean;
...
public class InternalGetterSetterRule {
	...
	/**
	 * Questo metodo ritorna true se il metodo passato in input e' un getter/setter
	 * di una delle variabili d'istanza
